...
def test_simulation():
  ...
  assert c.total_energy>=16*40*0.70 + 30
  assert c.total_capacity<16*40
  ...
  c.share_load(d["decision"], d["amount"], 1, OFF_PEAK)
  assert c.total_energy>=16*40*0.3 + 50
  assert c.total_capacity<16*40
  ...
  c.share_load(d["decision"], d["amount"], 1, OFF_PEAK)
  assert c.total_energy<=16*40*0.7 - 70
  assert c.total_capacity<16*40
  ...
  assert c.total_energy==16*40*0.85
  c.share_load(d["decision"], d["amount"], 1, OFF_PEAK)
  assert c.total_energy<=16*40*0.85 - 150
  assert c.total_capacity<16*40
  ...
  c.share_load(d["decision"], d["amount"], 1, OFF_PEAK)
  assert c.total_energy<=16*40*0.75 - 100
  assert c.total_capacity<16*40
